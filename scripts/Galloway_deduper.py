...
parser.add_argument('--paired',default = None, type=str, help='optional arg, designates \
...
if __name__ == "__main__":
    ...
    # lil error handling
    if args.paired != None:
        print(f"ERROR: This script does not yet have paired end capability")
        sys.exit()

    assert(args.file.split(".")[-1] == "sam")
    outfile = args.file[:-4] + "_deduped.sam"
    ...
    # de-dup'd sam file
    de_dup_sam_file_pointer = open(outfile, "w")
